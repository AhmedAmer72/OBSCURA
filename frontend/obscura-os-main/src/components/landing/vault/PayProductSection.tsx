        ...
        <div className="mx-auto max-w-[1400px] px-6 md:px-8">
          ...
          >
            ...
            <p className="mt-6 text-lg leading-relaxed text-muted-foreground">
              Obscura Pay is the payment layer of the Harmony workspace on Arbitrum Sepolia: shield and send
              ocUSDC with stealth receiving, confidential escrows, streams, and invoices — or flip to Public
              Mode for visible USDC through a passkey smart account. Unified settings, activity indexing,
